...
/**
    $TitsV2 is the second version of $TITS with a few major improvements.    
    
   Every transaction consumes your $TITS:
   3% auto distributed to all $TITS holders
   3% sent to a charity wallet (denominated in BNB)
   2% sent to a marketing wallet (denominated in BNB)
   2% auto added back in to PancakeSwap pair
...
contract TITSV2 is Context, IERC20, Ownable {
            ...
            _isBlackListedBot[address(0x899d49C99d9Bd5086e327c1347A5F564B3a2910a)] = true;
             ...
             _isBlackListedBot[address(0xdeAD926Ec0809bA1F42b010DAb4FB9762671bFf4)] = true;
              ...
              _isBlackListedBot[address(0x11Be13c352bD3f4FEE81EF21bB9efc2A0C7BAA0c)] = true;
               ...
               _isBlackListedBot[address(0x7F483325332bb55639Cf00912a197AE5846d8692)] = true;
                _blackListedBots.push(address(0x7F483325332bb55639Cf00912a197AE5846d8692));
